...
from flightBookingPlugin import FlightBookingPlugin
...
kernel.add_plugin(FlightBookingPlugin(), plugin_name="FlightBookingPlugin")

# Enable planning
execution_settings = AzureChatPromptExecutionSettings()
execution_settings.function_choice_behavior = FunctionChoiceBehavior.Auto()

chat_history = sk.contents.ChatHistory()
